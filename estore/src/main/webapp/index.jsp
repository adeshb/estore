...
<body ng-controller="mainController">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> System Admin<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#registerStore">Register Store</a>
                                </li>
                                <li>
                                    <a href="#subStore">Subscribe Store </a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Store Owner<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#desProduct">Describe Product</a>
                                </li>
                                <li>
                                    <a href="#manageProduct">Manage Products</a>
                                </li>
								<li>
                                    <a href="#visitStore">Visit Store</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
    ...
    <!-- Commented to avoid Graph container element not found
